            ...
            <div className="flex flex-row">
                ...
                <div className="w-3/4 pr-2">
                    ...
                    <Suspense fallback={<Loading section="Tab1" />}>
                        <NeracaDataX title="Tab1" titleTotal="Tab1" type={accType} group={accGroup} start={startPrevX} end={endPrev} />
                    </Suspense>
                ...
                <div className="w-3/5 pr-2">
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        <Suspense fallback={<Loading section="Tab2" />}>
                            <NeracaDataDebit title="Tab2" titleTotal="Tab2" type={accType} group={accGroup} start={start} end={end} />
                        </Suspense>

                        {/* kolom KREDIT */}
                        <Suspense fallback={<Loading section="Tab2" />}>
                            <NeracaDataCredit title="Tab2" titleTotal="Tab2" type={accType} group={accGroup} start={start} end={end} />
                        </Suspense>
