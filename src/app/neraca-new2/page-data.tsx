    ...
    return (
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-row gap-4">
                ...
                {/* AKTIVA - KIRI */}
                    ...
                    <div className="flex justify-between">
                        ...
                        <h1 className="text-xl font-bold pt-4 pb-2 text-blue-600 dark:text-orange-500">{titlePrevMonthYear}</h1>
                    </div>
                    <Divider />
                ...
                <h1 className="text-right text-xl font-bold pt-4 pb-2 text-blue-600 dark:text-orange-500">{titleMonthYear}</h1>
                    <Divider />
            ...
            {/* <div className="w-1/2"> */}
                ...
                <div className="basis-1/5">
                <h2 className="text-right text-xl font-bold pt-4 pb-2 text-blue-600 dark:text-orange-500">{titleMonthYear}</h2>
                    <Divider />
